...
import 'package:productos_app/widgets/comida_card.dart';
...
class ComidaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: MenuLateral(),
      backgroundColor: Color.fromARGB(255, 57, 68, 56),
       ...
       itemCount: productoService.productos.length,
        itemBuilder: (BuildContext context, int index) => GestureDetector(
            onTap: () {
              ...
              Navigator.pushNamed(context, 'comida_card');
            },
            child: ComidaCard(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          productoService.productoSeleccionado =
              new Comida(disponible: false, nombre: '', precio: 0);
          Navigator.pushNamed(context, 'comida_card');
        },
      ),
    );
