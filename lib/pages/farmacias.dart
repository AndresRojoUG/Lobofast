...
import 'package:productos_app/providers/farmacias_form_provider.dart';
...
class FarmaciaPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) =>
          FarmaciasFormProvider(productoService.productoSeleccionado!),
...
class _ProductoPageBody extends StatelessWidget {
  ...
  final FarmaciaService productoService;

  @override
  Widget build(BuildContext context) {
    final productoFormProvider = Provider.of<FarmaciasFormProvider>(context);
    return Scaffold(
      body: SafeArea(
