...
import 'package:productos_app/providers/comida_form_provider.dart';
...
class ComiPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final productoService = Provider.of<ComidaService>(context);
    //return _ProductoPageBody(productoService: productoService);
    return ChangeNotifierProvider(
      create: (_) =>
          ComidaFormProvider(productoService.productoSeleccionado!),
...
class _ProductoPageBody extends StatelessWidget {
  ...
  final ComidaService productoService;

  @override
  Widget build(BuildContext context) {
    final productoFormProvider = Provider.of<ComidaFormProvider>(context);
    return Scaffold(
      body: SafeArea(
